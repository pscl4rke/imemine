...
defbindings("WScreen", {
    ...
    kpress(META.."J", "ioncore.goto_next(_chld, 'down')", "_chld:non-nil"),
    kpress(META.."K", "ioncore.goto_next(_chld, 'up')", "_chld:non-nil"),
    kpress(META.."L", "ioncore.goto_next(_chld, 'right')", "_chld:non-nil"),

    bdoc("Launching a broswer"),
    submap(META.."I", {
        kpress(META.."I", "mod_query.exec_on_merr(_, '/home/psc/imemine/bin/open-in-browser https://duckduckgo.com/lite/?kl=uk-en&amp;kp=-2')"),
    }),
...
defbindings("WMPlex.toplevel", {
    ...
    kpress(META.."Return", "mod_query.exec_on_merr(_, '/home/psc/imemine/bin/open-in-terminal')"),

    bdoc("Query for command line to execute."),
    --kpress(ALTMETA.."F3", "mod_query.query_exec(_)"),
    kpress(META.."space", "mod_query.exec_on_merr(_, 'launchbear')"),
